...
out_folder = '/Users/miroslav/Desktop/X/'
folder = '/Users/miroslav/work/experiments_cluster/093_rnn_reaching_baseline/'
...
for i in range(240):
    try:
        ...
        with open(conf_file, 'r') as f:
            conf = yaml.load(f)
        if conf['rnn_noise_network'] == '/lustre/home/mbogdanovic/rnns/065_rnn_training/010/':
